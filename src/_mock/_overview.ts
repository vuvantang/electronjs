import IconChrome from 'assets/icons/app/ic_chrome.svg';
import IconDrive from 'assets/icons/app/ic_drive.svg';
import IconDropbox from 'assets/icons/app/ic_dropbox.svg';
import IconEvernote from 'assets/icons/app/ic_evernote.svg';
import IconGithub from 'assets/icons/app/ic_github.svg';
...
export const _appRelated = [
  ...
  const shortcut =
    (name === 'Chrome' && IconChrome) ||
    (name === 'Drive' && IconDrive) ||
    (name === 'Dropbox' && IconDropbox) ||
    (name === 'Evernote' && IconEvernote) ||
    IconGithub;
