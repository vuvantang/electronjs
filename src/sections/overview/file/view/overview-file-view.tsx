      ...
      data={[
        {
          ...
          usedStorage: GB / 2,
          filesCount: 223,
          icon: <Box component="img" src={Assets.icons.files.ic_img} />,
        },
        {
          name: 'Media',
          usedStorage: GB / 5,
          filesCount: 223,
          icon: <Box component="img" src={Assets.icons.files.ic_video} />,
        },
        {
          name: 'Documents',
          usedStorage: GB / 5,
          filesCount: 223,
          icon: <Box component="img" src={Assets.icons.files.ic_document} />,
        },
        {
          name: 'Other',
          usedStorage: GB / 10,
          filesCount: 223,
          icon: <Box component="img" src={Assets.icons.files.ic_file} />,
        },
      ]}
    />
  );
        ...
        <Grid container spacing={3}>
          ...
          <Grid xs={12} sm={6} md={4}>
            <FileWidget
              ...
              value={GB / 10}
              total={GB}
              icon={Assets.icons.app.ic_dropbox}
            />
          </Grid>
          ...
          <Grid xs={12} sm={6} md={4}>
            <FileWidget
              ...
              value={GB / 5}
              total={GB}
              icon={Assets.icons.app.ic_drive}
            />
          </Grid>
          ...
          <Grid xs={12} sm={6} md={4}>
            <FileWidget
              ...
              value={GB / 2}
              total={GB}
              icon={Assets.icons.app.ic_onedrive}
            />
          </Grid>
