...
const IconPlatform: { [x: string]: any } = Assets.icons.platforms;
    ...
    >
      ...
      >
        <Box
          ...
          src={
            isLight
              ? Assets.images.home.hero.light_1
              : Assets.images.home.hero.dark_1
          }
      ...
      >
        <Box
          ...
          src={
            isLight
              ? Assets.images.home.hero.light_2
              : Assets.images.home.hero.dark_2
          }
          sx={{ position: 'absolute', mt: -5 }}
        />
        <Box
